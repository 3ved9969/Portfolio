  ...
  return (
    <nav className={`fixed top-0 w-full z-50 transition duration-300 px-[7vw] md:px-[7vw] lg:px-[20vw] ${
      ...
      <div className='text-white py-5 flex justify-between items-center'>
        ...
        <span className='text-[#8245ec]'>/</span>
        <span className='text-white'>Thrived Sai</span>
        <span className='text-[#8245ec]'>&gt;</span>
        </div>
        {/*Desktop Menu*/}
        ...
        <div className='hidden md:flex space-x-4'>
          <a 
            href='https://github.com/3ved9969'
            target='_blank'
          ...
          <a 
            href='https://www.linkedin.com/in/thrived-sai-2580a9315?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app'
            target='_blank'
            rel='noopener noreferrer'
            className='text-gray-300 hover:text-[#8245ec]'
            >
